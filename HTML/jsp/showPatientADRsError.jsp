	...
	<%@page import="java.sql.*,java.util.*"%>
		...
		<head>
				<meta charset="utf-8" />
		<title>Patient Raised ADRs</title>
		...
		<div align="center">
		  <!-- /. main-header -->
		  <span class="btn-success page-description">ADRs Raised by Patients</span>
	    </div>
		<div align="center">
		...
		prop.load(fis);
		 ...
		 String sql = "select adrid,patientName,gender,age,contactNumber,emailAddress,medicine,dose,doseQuantity,problemOccuredDate,symptomesObserved,majorAffect,userLogin from patientADRs";
		...
		<%
		 if(!resultSet.getString(13).equals("guest")){%>
			 		 <TD class="btn-warning"> <a href="sendReplay.jsp?userLogin=<%=resultSet.getString(13)%>,<%=resultSet.getString(1)%>,<%=resultSet.getString(7)%>"> Send Replay
		 </a>
		 <%}
		 else{%>

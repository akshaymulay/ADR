	...
	<%@page import="java.sql.*,java.util.*"%>
		...
		prop.load(fis);
		 ...
		 String sql = "select adrid,pharmacistName,pharmacistContact ,medicine ,productManufacture ,manufacturingDate ,expirationDate ,noPrescription ,personpDetails,anotherProduct,problemOccured,reactionBycustomer,sideEffect,userLogin from pharmacistADRs";

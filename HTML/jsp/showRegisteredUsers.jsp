	...
	<%@page import="java.sql.*,java.util.*"%>
		...
		<div align="center">
		  <!-- /. main-header -->
		  <span class="btn-success page-description">Registered User Details</span>
	    </div>
		<div align="center">
		...
		prop.load(fis);
		 ...
		 String sql = "select firstName,lastName,contactNumber,emailAddress from registeredUsers";

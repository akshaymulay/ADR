		...
		<header class="main-header">
					  ...
					  <div class="container">
						<div id="navbar" class="navbar-collapse collapse pull-right">
						  <ul class="nav navbar-nav">
							<li><a class="is-active" href="profile.jsp">Home</a></li>
				...
				<div class="btn-success" align="center"><font size=4px>Adverse Drug Reaction Reported to DCGI Successfully..!</font></div>
		<h1>Welcome <%= session.getAttribute("userLogin")%></h1>
		</br>
				<div>
				 <center> <img src="../assets/images/reportMatter.jpg" height="400" width="880"> </center>
				  </div>
				  <p>&nbsp</p>
				  <p>&nbsp</p>
